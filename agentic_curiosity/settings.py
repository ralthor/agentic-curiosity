...
LOGIN_RATE_LIMIT_ATTEMPTS = env_int('LOGIN_RATE_LIMIT_ATTEMPTS', default=5)
LOGIN_RATE_LIMIT_WINDOW_SECONDS = env_int('LOGIN_RATE_LIMIT_WINDOW_SECONDS', default=300)
